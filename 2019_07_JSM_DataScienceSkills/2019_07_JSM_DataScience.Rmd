...
# Data Science/Kaggle: Python, R, SQL

.pull-left[
<center><img src="img/kaggle_languages.png" width="100%"/></center>
]
.pull-right[
<center><img src="img/kaggle_languages_most_often.png" width="100%"/></center>
]
[Business Over Broadway - Bob Hayes](https://businessoverbroadway.com/2019/01/13/programming-languages-most-used-and-recommended-by-data-scientists/)
---
...
- Difficult to do when busy, unless you set aside time (make a deadline) or find an immersive experience
...
#### R specific learning checks from Alison Hill's [Big Magic with R: Creative Learning Beyond Fear](https://alison.rbind.io/talk/2018-cascadia-bigmagic/)
...
---
class:inverse
<center><img src="img/horst_r_first_then.png" width="54%" height="50%"><a href="https://github.com/allisonhorst/stats-illustrations"><br>Allison Horst</a></center>
---
