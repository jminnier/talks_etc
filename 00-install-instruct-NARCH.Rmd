...
- By registering, this will allow you to view the data in the workshop. 
    + No need to download data yourself, but if interested later you can view the full data can be found here: https://hrsdata.isr.umich.edu/data-products/
...
- Get acquainted with Posit Cloud or Rstudio Desktop (and R) prior to the workshop. You will get much more out of the workshop if you have opened the software and explored the interface first.
...
[Jessica Minnier, PhD](http://jessicaminnier.com/) & [Emile Latour, M.S.](https://www.ohsu.edu/knight-cancer-institute/biostatistics-shared-resource), with materials co-developed with [Meike Niederhausen, PhD](https://ohsu-psu-sph.org/faculty-2/faculty-directory/?cn-s=niederhausen&cn-cat=), 
