...
-   Consider hormone-based biological mechanisms
:::
...
# Characterizing Confounding


::::: columns
::: {.column width="50%"}

1. **discriminatory** confounding: effects of the confounder on the exposure and the outcome are due to individual or systemic discrimination
2. **sociocultural** confounding: effects are due to personal sociocultural practices
3. **biological** confounding: effects are directly due to biological mechanisms

"We adjusted for race": now what? A systematic review... `r Cite(key = "swilley2023we", bib=myBib, textual = TRUE, .opts=list(cite.style="authoryear"))`
:::
::: {.column width="50%"}

![](img/age_confounder.jpeg)
...
- Do you encounter issues of data equity in your own research or clinical area?
    + How were these issues/ideas considered in the past. Would you change anything about this?
- What is one major source of selection bias you've encountered? How do you think this bias might be affecting the conclusions of studies in your field?
- We discussed 'positionality'—how our own experiences and biases shape our work. As clinicians and researchers, how might our positionality influence the research questions we choose to ask, or the variables we choose to collect, when studying health disparities?
- If you read a study that states, "After adjusting for race, we found no significant difference in 30-day mortality between patient groups." What are we really adjusting for when we put "race" into a model? What important structural factors or SDOH might this adjustment be hiding?"
...
-   Slides: [bit.ly/hip25_data_eq](https://bit.ly/hip25_data_eq)
