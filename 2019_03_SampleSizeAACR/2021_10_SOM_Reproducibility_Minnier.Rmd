...
date: 'SOM Rigor & Reproducibility<br>October 19, 2021<br><br>`r icons::fontawesome("link")` [bit.ly/som-power](https://bit.ly/som-power21)<br>`r icons::fontawesome("twitter")` [datapointier](https://twitter.com/datapointier)'
output:
