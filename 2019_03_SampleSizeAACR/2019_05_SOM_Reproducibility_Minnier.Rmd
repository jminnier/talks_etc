...
date: 'SOM Rigor & Reproducibility<br>May 3, 2019<br><br>`r icon::fa("link")` [bit.ly/som-power](https://bit.ly/som-power)<br>`r icon::fa("twitter")` [datapointier](https://twitter.com/datapointier)'
output:
