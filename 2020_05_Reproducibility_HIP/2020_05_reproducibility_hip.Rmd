...
.pull-left[
`r Cite(bib=myBib,key="Resnik_2019",textual=TRUE, .opts=list(cite.style="authoryear"))` ["Effect of Impact Factor and Discipline on Journal Data Sharing Policies"](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6533124/): Stratified sampling of scientific disciplines
