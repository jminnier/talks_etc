...
date: 'HIP 523 Data Science for Research<br><br>`r icon::fa("link")` [bit.ly/hip-repro](https://bit.ly/hip-repro)<br>`r icon::fa("twitter")` [datapointier](https://twitter.com/datapointier)'
output:
